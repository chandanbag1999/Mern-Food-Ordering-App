...
export default function UserProfileForm({ onSave, isLoading, currentUser }: Props) {
  ...
  return(
    <Form {...form}>
      <form 
        onSubmit={form.handleSubmit(onSave)} className="space-y-4 bg-gray-50 rounded-lg md:p-10"
      >
        <div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex-1">
              ...
              <FormControl>
                <Input placeholder="San Francisco" {...field}  className="bg-white" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex-1">
              ...
              <FormControl>
                <Input placeholder="United States" {...field}  className="bg-white" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
